...
public class ThumbViewActionApproveReject extends ThumbViewBase {
    ...
    public ThumbViewActionApproveReject(Context context, Map<String, Object> map, String username, Typeface tt) {
    ...
    protected Button getButtonAccept() {
        if (null == m_btnAccept) {
            ...
            m_btnAccept = (Button) LayoutInflater.from(this.getContext()).inflate(R.layout.innohawk_view_action_button_accept, null, false);
    ...
    protected Button getButtonReject() {
        if (null == m_btnReject) {
            ...
            m_btnReject = (Button) LayoutInflater.from(this.getContext()).inflate(R.layout.innohawk_view_action_button_reject, null, false);
