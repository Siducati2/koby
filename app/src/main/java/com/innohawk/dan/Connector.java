...
public class Connector extends Object implements Serializable {
    ...
    private static final String TAG = "OO1 Connector";
    ...
    protected int m_iUnreadChats;
    protected int m_iUnreadFeeds;
    protected int m_iUnreadDeals;
    protected int m_iUnreadNoti;
    ...
    public String execAsyncMethod(String sMethod, Object[] aParams, Callback oCallBack, Context context) {
    ...
    class XMLRPCMethod extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                handler.post(new Runnable() {
                    public void run() {
                        Log.e(TAG, "Error a: " + e.getMessage());
                        setLoadingIndicator(false);
                ...
                handler.post(new Runnable() {
                    public void run() {
                        Log.e(TAG, "Error b: " + e.getMessage());
                        setLoadingIndicator(false);
    ...
    //Custom innohawk
    public int getUnreadChatsNum() {
        return m_iUnreadChats;
    }

    public int setUnreadChatsNum(int i) {
        return (m_iUnreadChats = i);
    }

    public int getUnreadFeedsNum() {
        return m_iUnreadFeeds;
    }

    public int setUnreadFeedsNum(int i) {
        return (m_iUnreadFeeds = i);
    }

    public int getUnreadDealsNum() {
        return m_iUnreadDeals;
    }

    public int setUnreadDealsNum(int i) {
        return (m_iUnreadDeals = i);
    }

    public int getUnreadNotiNum() {
        return m_iUnreadNoti;
    }

    public int setUnreadNotiNum(int i) {
        return (m_iUnreadNoti = i);
    }
