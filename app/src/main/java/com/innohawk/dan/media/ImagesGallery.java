...
public class ImagesGallery extends ActivityBase {
    ...
    protected Button btn_action_prev;
    protected Button btn_action_avatar;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        textTitle.setText(R.string.title_image_gallery);
        ...
        //Next
        btn_action_next = (Button) findViewById(R.id.media_images_gallery_next);
        ...
        //Prev
        btn_action_prev = (Button) findViewById(R.id.media_images_gallery_prev);
        btn_action_prev.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                prevFx();
            }
        ...
        //Avatar
        btn_action_avatar = (Button) findViewById(R.id.media_images_gallery_make);
        btn_action_avatar.setVisibility(View.INVISIBLE);
        btn_action_avatar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onBackPressed();
            }
        ...
        String value_makeavatar = i.getStringExtra("makeavatar"); //Es para ver si habilitamos el make avatar!!!!
        if (value_makeavatar.equals("yes"))
            btn_action_avatar.setVisibility(View.VISIBLE);
        else
            btn_action_avatar.setVisibility(View.INVISIBLE);
        ...
        oConnector.execAsyncMethod("dolphin.getImagesInAlbum", aParams, new Connector.Callback() {
            ...
            public void callFinished(Object result) {
                ...
                if (m_aFiles.length < 1) {
                    ...
                    m_adapterFiles = null;
                    m_adapterFiles = new ImagesFilesAdapter(m_actThis, m_aFiles, m_sUsername, tt);
    ...
    protected void prevFx() {
        setImageIndex(m_iIndex - 1);
    }

    protected void nextFx() {
        setImageIndex(m_iIndex + 1);
    }

    protected void makeavatar() {
        Connector oConnector = Main.getConnector();
