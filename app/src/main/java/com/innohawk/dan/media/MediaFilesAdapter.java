...
public class MediaFilesAdapter extends BaseAdapter {
    ...
    public MediaFilesAdapter(Context context, Object[] aFiles, String sUsername, Typeface tt) {
        m_context = context;
    ...
    public View getViewReal(int i) {
        ...
        Map<String, Object> map = (Map<String, Object>) m_listFiles.get(i);
        if (isDeleteAllowed())
            return new ThumbViewMediaEdit(m_context, map, m_sUsername,tt);
        else
            return new ThumbViewMedia(m_context, map, m_sUsername,tt);
    }
