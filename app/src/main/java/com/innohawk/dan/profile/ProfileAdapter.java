...
public class ProfileAdapter extends BaseAdapter {
    ...
    Typeface tt;
    public ProfileAdapter(Context context, Map<String, Object> mapProfileInfo, Object[] aMenu, String username, Typeface tt) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (0 == position) { // first view is always profile info
            m_actProfileView = new ProfileView(m_context, m_map, m_sUsername,tt);
