...
public class SplashSplashView extends View {
     ...
     * @param context
     */
    public SplashSplashView(Context context){
        super(context);
        initialize();
    }
     ...
     * @param attrs
     */
    public SplashSplashView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize();
     ...
     * @param attrs
     */
    public SplashSplashView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initialize();
        setupAttributes(attrs);
    }

    public static final int DEFAULT_HOLE_FILL_COLOR = Color.TRANSPARENT;
            ...
            public void onAnimationEnd(Animator animation){
                ...
                if(mRemoveFromParentOnEnd){
                    ...
                    if(parent != null && parent instanceof ViewManager){
                        ...
                        viewManager.removeView(SplashSplashView.this);
