...
import com.innohawk.dan.actionbar.ActionBarListActivity;
...
abstract public class ListActivityBase extends ActionBarListActivity {
    ...
    public void setContentView(int iLayoutResID) {
        ...
        if ((sClass.equals("Main")) || sClass.equals("HelpActivity")){
            //No se muestra NavBar
        } else {
               ...
               // m_layoutToolbarContainer.setBackgroundColor(Color.TRANSPARENT);
                ...
                if (aActivityHome.length() != 0) {
                    try {
                        ...
                        Log.d(TAG, "ListActivity:: El valor de Control  es::" + controlActivity + "");
    ...
    protected void gotoHome() {
        if (!(m_HomeactThis instanceof VideosActivity)) {
